...
class JobHuntSankey:
    ''' Sankey diagram describing job hunt. Each entry corresponds a differente stage of the application process (e.g. Application, Interview 1, Interview 2, ..., Status).
